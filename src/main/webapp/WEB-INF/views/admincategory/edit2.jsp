...
<style type="text/css">
  ...
  <body>
    ...
    <form action="<c:url value='/category/editchild'/>" method="post" onsubmit="return checkForm()">
...
<c:forEach items="${parents }" var="parent">
    	...
    	分类描述：<textarea rows="5" cols="50" name="cdesc" id="cdesc">${child.cdesc }</textarea><br/>
