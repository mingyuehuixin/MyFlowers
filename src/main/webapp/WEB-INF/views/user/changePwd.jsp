...
<html>
  <head>
	...
	<link rel="stylesheet" type="text/css" href="<c:url value='../static/css/user/pwd.css'/>">
  ...
  <body>
	...
	<div class="div1">
		<form action="<c:url value='../user/changePwd'/>" method="post" target="_top">
		...
		<table>
			...
			<tr>
				<td align="right"></td>
				<td>
				  <img id="vCode" src="<c:url value='../user/getVerifyCode'/>" border="1"/>
